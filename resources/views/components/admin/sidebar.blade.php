...
<div class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <!-- genre item -->
            <li class="{{ request()->routeIs('admin.genres.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.genres.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Genre">
                    <!-- icon genre -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <!-- riwayat pemesanan / booking item -->
            <li class="{{ request()->routeIs('admin.riwayats.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.riwayats.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Riwayat">
                    <!-- icon pemesanan/booking -->
