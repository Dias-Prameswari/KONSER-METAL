    ...
    <section class="max-w-4xl mx-auto py-12 px-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="text-sm text-gray-500">Booking #{{ $booking->id }} •
                {{ $booking->order_date->format('d M Y H:i') }}
            </div>
        </div>
        ...
        <div class="card bg-base-100 shadow-md">
            <div class="lg:flex ">
                <div class="lg:w-1/3 p-4">
                    <img
                        src="{{ $booking->show?->gambar ? asset('storage/' . $booking->show->gambar) : 'https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp' }}"
