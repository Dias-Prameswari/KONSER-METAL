<x-layouts.admin title="Tambah Show Baru">
    @if ($errors->any())
    ...
    <div class="container mx-auto p-10">
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <h2 class="card-title text-2xl mb-6">Tambah Show Baru</h2>

                <form id="showForm" class="space-y-4" method="post" action="{{ route('admin.shows.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- nama show -->
                    ...
                    <div class="form-control">
                        ...
                        <textarea
                            name="deskripsi"
                            placeholder="Deskripsi lengkap tentang show..."
